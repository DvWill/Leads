...
type Props = { leadId: string; phone: string | null; mapsUrl?: string | null; compact?: boolean; blocked?: boolean };

export function LeadActions({ leadId, phone, mapsUrl, compact = false, blocked = false }: Props) {
  ...
  return (
    <>
      ...
      {modal ? (
        <div className="fixed inset-0 z-[70] grid place-items-center bg-slate-950/50 p-4 backdrop-blur-sm" role="dialog" aria-modal="true" aria-labelledby="whatsapp-title">
