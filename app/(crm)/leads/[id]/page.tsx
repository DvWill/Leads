  ...
  return <div className="space-y-6">
    ...
    <section className="card p-5 sm:p-6">
      <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
        ...
        <LeadActions leadId={lead.id} phone={(lead as {phoneNormalized?: string|null}).phoneNormalized ?? null} mapsUrl={lead.googleMapsUrl} blocked={blocked} canDelete={data.canDelete} afterDeleteHref="/leads" lead={{ title: lead.title, categoryName: lead.categoryName, categories: lead.categories, city: lead.city, state: lead.state, searchString: lead.searchString, stageName: lead.stage.name }} />
      </div>
